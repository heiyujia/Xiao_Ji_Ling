...
class Surface (object):
    ...
    def Start_a_Project(self):
        ...
        if self.project_name == '':
            try:
                raise Warning_Blank(message = 'Please give a name for project')
            except Warning_Blank as e:
                tkinter.messagebox.showinfo('Warning', e.message)
